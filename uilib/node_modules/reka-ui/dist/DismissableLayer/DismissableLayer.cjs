...
var DismissableLayer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { emit: __emit }) {
		...
		(0, vue.watch)([layerElement, () => props.disableOutsidePointerEvents], ([element, disableOutsidePointerEvents], _, onCleanup) => {
			if (!element) return;
			if (disableOutsidePointerEvents) {
				...
				onCleanup(() => {
					...
					if (context.layersWithOutsidePointerEventsDisabled.size === 0 && !require_shared_nullish.isNullish(context.originalBodyPointerEvents)) ownerDocument.value.body.style.pointerEvents = context.originalBodyPointerEvents;
				});
			}
